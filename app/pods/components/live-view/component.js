...
export default Ember.Component.extend({
  ...
  webcamTimerFired() {
        var d = new Date();
        $('#camera-infra').attr('src', 'http://10.69.0.23:8081?'+d.getTime()); // infra motion
        //$('#camera-infra').attr('src', 'http://10.69.0.23:8080/stream/video.mjpeg'); // infra uv4l
        $('#camera-green2').attr('src', 'http://10.69.0.27:8081?'+d.getTime()); // green2
        //$('#camera-green2').attr('src', 'http://10.69.0.27:8080/stream/video.mjpeg'); // green2 uv4l
        $('#camera-green3').attr('src', 'http://10.69.0.20:8081?'+d.getTime()); // green3
        ...
        $('#camera-motion').attr('src', 'http://10.69.0.26:8081?'+d.getTime()); // motion
